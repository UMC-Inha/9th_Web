...
import { useLpDetailQuery } from "../hooks/queries/useLpDetailQuery.js";
import { useInfiniteComments } from "../hooks/queries/useInfiniteComments.js";
import { useCommentMutations } from "../hooks/queries/useCommentMutations.js";
import { useDeleteLpMutation } from "../hooks/queries/useDeleteLpMutation.js";
import { useUpdateLpMutation } from "../hooks/queries/useUpdateLpMutation.js";
import type { CommentItem, CommentListResponse } from "../apis/comments.js";
...
import {
  isLikedByMe,
  useToggleLpLikeMutation,
} from "../hooks/queries/useToggleLpLikeMutation.js";
...
export default function LpDetailPage() {
  ...
  /** ⭐ 좋아요 mutation 훅 */
  const { mutate: toggleLike } = useToggleLpLikeMutation(lpId, myUserId!);
  const isLiked = lp ? isLikedByMe(lp, myUserId!) : false;
