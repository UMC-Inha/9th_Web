    ...
    <div className="flex flex-col items-center justify-center h-full gap-4">
      <div className="flex flex-col gap-3">
        ...
        <button
          ...
          className="w-full py-2 border border-gray-400 py rounded-md flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors cursor-pointer"
        >
          <img src={watermark} alt="Google _logo _img" className="w-5 h-5" />
          <span>구글 로그인</span>
        </button>
